                            ...
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                <div class="flex items-center">
                                    ...
                                    @if (auth()->user()->role == 'admin')
                                        <span class="ms-2 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-white bg-red-500 rounded-full">
                                            {{-- admin --}}
                                        </span>
                                    @endif
                                </div>
        ...
        @auth
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="px-4 flex items-center justify-between">
                    ...
                    @if (auth()->user()->role == 'admin')
                        <span class="px-2 py-0.5 text-[10px] font-bold uppercase text-white bg-red-500 rounded-full">Admin</span>
                    @endif
                </div>
